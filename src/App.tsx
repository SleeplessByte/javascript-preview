...
const SOURCE_EXT: Record<Track, string> = {
  javascript: 'js',
  typescript: 'ts',
}

const TESTS_EXT: Record<Track, string> = {
  javascript: 'spec.js',
  typescript: 'spec.ts',
}
...
interface Configuration extends Readonly<Configuration> {
  language: 'JavaScript'
  active: true
  blurb: string
  test_pattern: string
